...
export function createProducts(products) {
	...
	products.forEach(function (product) {
		productsContainer.innerHTML += `<div class="card col-sm-12 col-md-6 col-lg-3 products__card" style="width: 12rem;">
						 <img src="${product.attributes.image_url}" alt="${product.attributes.title}" class="products__img">							
						 <h5 class="products__title">${product.attributes.title}</h5>      
						 <p class="products__price">${product.attributes.price} NOK</p>
